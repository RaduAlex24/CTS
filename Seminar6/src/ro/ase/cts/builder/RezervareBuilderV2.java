...
public class RezervareBuilderV2 implements AbstractBuilder {
    ...
    public RezervareBuilderV2 setMuzicaAmbinetalaPersonalizata(boolean muzicaAmbinetalaPersonalizata) {
    ...
    public Rezervare build() {
        return new Rezervare(cod, mancareInclusa, scaunErgonomic,
                bauturaRacoritoareInclusa, muzicaAmbinetalaPersonalizata,
                genMuzica);
    }
}
